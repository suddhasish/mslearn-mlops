# Azure MLOps Infrastructure - Complete Modular Configuration
# Enterprise-grade MLOps infrastructure with comprehensive modular design
# All infrastructure components are organized into focused, reusable modules
...
# ML Workspace Module - ML Workspace, Key Vault, App Insights, Compute
module "ml_workspace" {
...
# AKS Module - Kubernetes cluster for model serving
module "aks" {
  source = "./modules/aks"
...
# RBAC Module - Custom roles, service principals, managed identities
module "rbac" {
  source = "./modules/rbac"
...
# Private Endpoints Module - Private networking for services
module "private_endpoints" {
  ...
  key_vault_id               = module.ml_workspace.key_vault_id
  key_vault_name             = module.ml_workspace.key_vault_name
  container_registry_id      = module.storage.container_registry_id
  container_registry_name    = module.storage.container_registry_name
  ml_workspace_id            = module.ml_workspace.workspace_id
  ml_workspace_name          = module.ml_workspace.workspace_name
  tags                       = local.common_tags

  depends_on = [module.networking, module.storage, module.ml_workspace]
}

# ============================================================================
# CACHING & PERFORMANCE MODULES
# ============================================================================

# Cache Module - Redis cache for ML inference
module "cache" {
...
# ============================================================================
# DEVOPS & ANALYTICS MODULES
# ============================================================================

# DevOps Integration Module - Data Factory, Power BI, SQL, Event Grid, Functions
...
# Cost Management Module - Budgets, automation, cost optimization
