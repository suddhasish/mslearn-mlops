# PROD Environment - MLOps Infrastructure
# Production-grade configuration with enhanced security
...
module "aks" {
  ...
  enable_gpu_node_pool       = false  # Disabled (no GPU quota in subscription)
  tags                       = local.common_tags
}
